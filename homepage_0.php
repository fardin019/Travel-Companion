...
<html>
    ...
    <body>
            <nav class="navbar navbar-expand-md navbar-light sticky-top" style="background-color: #ddeeff;">
                     <b class="navbar-brand">Travel Companion</b>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav">
                            <a href="signin.php" class="nav-item nav-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sign up/LogIn</a>
                        </div>
                    </div>
                </nav>
            <div class="front-img">
            ...
            <div class="jumbotron jumbotron-fluid">
                <div class="gallery">
                        ...
                        <figure class="gallery__item gallery__item--3">
                            <a href="signin.php"><img src="1e.jpg" class="gallery__img" alt="Image 3"></a>
                            <div class="post-s"><h2>Tanga</h2></div>
                        </figure>
                        <figure class="gallery__item gallery__item--4">
                            <a href="signin.php"><img src="znz_coast.jpg" class="gallery__img" alt="Image 4"></a>
